...
class BaseEntity(object):
    ...
    def markAsRemoved(self):
        entity_status = EntityStatus.ARCHIVE
...
class BaseAggregateRoot(BaseEntity):
    ...
    * Event Publisher is injected by Factory/Repo
    ...
    def set_event_pubslisher(self, domain_event_publisher):
        """
        ...
        """
        assert not self.domain_event_publisher, "Publisher is already set! Probably You have logical error in code"
